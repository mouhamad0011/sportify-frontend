...
function Login() {
  ...
  const handleRegistration = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/users/add', newUser, {
        headers: {
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.get(`http://localhost:5000/users/getOneUserByEmailPassword/${loginEmail}/${loginPassword}`);
